...
export const projectAccomplishmentUploadConfig: UploadWizardConfig = {
    type: 'project-accomplishment',
    title: 'Project Accomplishment Report Upload',
    description:
        'Prepare a project accomplishment report with the full 9-step workflow.',
    eyebrow: 'Project Accomplishment Report',
    ...
    steps: [
        {
            ...
            title: 'Doc Type',
            description:
                'Confirm this submission as a project accomplishment report.',
            defaultValues: createReportDocTypeData('project-accomplishment'),
        ...
        },
        {
            id: 'details',
            title: 'Details',
            description: 'Capture project and accomplishment report details.',
        ...
        },
        {
            ...
            title: 'Review',
            description:
                'Review the prepared project accomplishment report submission.',
