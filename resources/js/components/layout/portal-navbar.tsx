...
const navigationItems: Array<{
    ...
    { key: 'browse-research', label: 'Browse Research', href: '/browse-research' },
...
export default function PortalNavbar({
    ...
    return (
        <header className="sticky top-0 z-50 border-b border-[#e5e7eb] bg-white shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)]">
            <div className="mx-auto flex min-h-16 w-full max-w-[1552px] flex-wrap items-center gap-3 px-4 py-3 lg:flex-nowrap lg:px-6 lg:py-0 xl:px-11 2xl:px-44">
                ...
                <div className="relative order-3 w-full lg:order-none lg:ml-8 lg:w-[448px]">
                    <Search className="pointer-events-none absolute top-1/2 left-3 size-4 -translate-y-1/2 text-[#9ca3af]" />
                    <div className="flex h-[38px] items-center rounded-[10px] border border-[#e5e7eb] bg-[#f9fafb] pr-4 pl-10 text-sm text-[rgba(10,10,10,0.5)]">
